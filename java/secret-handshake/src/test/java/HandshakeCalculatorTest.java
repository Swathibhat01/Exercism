...
public class HandshakeCalculatorTest {
    ...
    public void test(){
        assertEquals("101",
            handshakeCalculator.convertFromDecimalToReversedBinary(5));
        assertEquals("001",
            handshakeCalculator.convertFromDecimalToReversedBinary(4));
        assertEquals("10011",
            handshakeCalculator.convertFromDecimalToReversedBinary(25));
        assertEquals("11001",
            handshakeCalculator.convertFromDecimalToReversedBinary(19));
        assertEquals("110001",
            handshakeCalculator.convertFromDecimalToReversedBinary(35));
        assertEquals("0101",
            handshakeCalculator.convertFromDecimalToReversedBinary(10));
